...
TODO (shashank): Shall we normalize the scores before performing weight decay?
...
def soft_nms(boxes, scores, thresh=0.001, **kwargs):    
    ...
    # sort the final decayed scores and send them all, later we can selected top-k based on POST_NMS_SIZE
    sorted_scores, sorted_inds = torch.sort(scores, descending=True)
