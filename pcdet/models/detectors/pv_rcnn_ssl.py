...
class DimDistributionRegistry(object):
    def __init__(self, ):
        self._tag_metrics = {}
...
class PVRCNN_SSL(Detector3DTemplate):
    def __init__(self, model_cfg, num_class, dataset):
        ...
        self.dimension_dist_registry = DimDistributionRegistry()
    ...
    def forward(self, batch_dict):
        if self.training:
            ...
            batch_dict['dimension_dist_registry'] = self.dimension_dist_registry
            ...
            if self.model_cfg.ROI_HEAD.get('ENABLE_RCNN_CONSISTENCY', False) or self.model_cfg.get('UNLABELED_SUPERVISE_OBJ', False):
