...
def class_agnostic_nms(box_scores, box_preds, nms_config, score_thresh=None, topk_proposals=None):
    ...
    if box_scores.shape[0] > 0:
        if topk_proposals is None:
            ...
            _, selected = torch.topk(box_scores, k=min(topk_proposals, box_scores.shape[0]))
